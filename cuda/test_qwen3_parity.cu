// test_qwen3_parity.cu — numeric parity of fucina's Qwen3 dense forward vs llama.cpp.
// Feeds the EXACT input token ids llama.cpp produced for "The capital of France is"
// through fucina's arch-driven multiseq path (seq_add + greedy step_batch) and checks
// the greedy continuation matches llama.cpp's (same Q4_K_M GGUF → quant-matched).
//
// llama.cpp (Q4_K_M, greedy) reference:
//   input:        [785, 6722, 315, 9625, 374]              ("The capital of France is")
//   continuation: [12095, 13, 576, 6722, 315, 15344, 374, 21718]  (" Paris. The capital of Italy is Rome")
#include <cstdio>
#include <cstdlib>
#include <cstdint>
