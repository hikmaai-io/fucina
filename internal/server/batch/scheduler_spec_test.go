...
// per req — modelling a lossless verify that accepts a prefix of the draft.
...
// appended, the history tail [2 3 1] recurs earlier — so prompt-lookup proposes a
// draft on the very first step. (mockEngine.AddSeq returns slot*1000+1; slot 0 → 1.)
