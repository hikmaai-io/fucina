...
- **TC-60 Cross-Turn Sleeper Injection still fails** at the model level after byte-exact
  Qwen3.6 template and role-boundary verification; see
  [`tc60-cross-turn-injection.md`](tc60-cross-turn-injection.md).
