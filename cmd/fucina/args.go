...
type CLIArgs struct {
	...
	ExpertResidency string // --expert-residency-plan: calibration-derived startup placement
	Debug           bool
	LogLevel        string
...
func parseArgs(fs *flag.FlagSet, argv []string) (CLIArgs, testFlags, error) {
	...
	fs.StringVar(&a.ExpertResidency, "expert-residency-plan", "", "Calibration-derived expert residency manifest")
